...
import { fetchUpstreamAuthToken, getUpstreamAuthorizeUrl, type Props } from "./oauth-utils";
import {
	addApprovedClient,
	bindStateToSession,
	createOAuthState,
...
app.get("/authorize", async (c) => {
	...
	return renderApprovalDialog(c.req.raw, {
		...
		csrfToken,
		server: {
			description: "Life Hub — a personal life-tracking MCP server, authenticated via GitHub.",
